        ...
        <div className="max-w-full mb-16 text-center">
          ...
          >
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full bg-[#1E1E1E] px-6 py-2.5 text-xl font-medium text-white transition-all hover:bg-black active:scale-95 shadow-sm"
            >
              Join the Waitlist
              <svg
                width="12"
